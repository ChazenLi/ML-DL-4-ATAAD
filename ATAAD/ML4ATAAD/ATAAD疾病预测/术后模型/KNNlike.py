...
knn_gscv.fit(X_train_balanced, y_train_balanced)
...
# 特征贡献度分析
importances = best_knn.kneighbors(X_train_balanced, return_distance=False)
feature_importance = np.mean(np.abs(X_train_balanced[importances]), axis=1)
